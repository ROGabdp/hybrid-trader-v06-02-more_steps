...
RESULTS_PATH = os.path.join(PROJECT_PATH, 'results_backtest_v5_dca_hybrid_dynamic_n_kd_filter_next')
                ...
                for action in self.pending_actions:
                    ...
                    if act_type == 'BUY_DCA':
                        ...
                        if real_fund > open_price:
                            ...
                            ai_positions.append({'shares': shares, 'buy_price': open_price, 'buy_idx': i, 'cost': cost})
...
def generate_end_date_summary(bt1, twii_df, start_date, end_date, buy_model, sell_model, 
    ...
    if ai_positions:
        ...
        for idx, pos in enumerate(ai_positions, 1):
            ...
            lines.append(f"       報酬: {return_pct:+.2f}%")
        lines.append("-" * 60)
